			...
			<div class="row">
				<div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
					...
					<nav aria-label="Page navigation">
						<ul class="pagination">
							<li v-if="Pagination.showFirstPage">
								<a @click="getDiscussList(1,5)" aria-label="Previous">
									<span aria-hidden="true">&lt;&lt;</span>
								</a>
							</li>
							<li v-if="Pagination.showPrevious">
								<a @click="getDiscussList(Pagination.page-1,5)" aria-label="Previous">
									<span aria-hidden="true">&lt;</span>
								</a>
							</li>
							...
							<li
								...
								:key="index"
								v-bind:class="{active:Pagination.page == item}"
							>
								<a @click="getDiscussList(item,5)">{{item}}</a>
							</li>

							<li v-if="Pagination.showNext">
								<a @click="getDiscussList(Pagination.page+1,5)" aria-label="Previous">
									<span aria-hidden="true">&gt;</span>
								</a>
							</li>
							<li v-if="Pagination.showEndPage">
								<a @click="getDiscussList(Pagination.totalPage,5)" aria-label="Previous">
									<span aria-hidden="true">&gt;&gt;</span>
								</a>
							</li>
						</ul>
